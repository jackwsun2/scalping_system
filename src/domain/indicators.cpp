                                                  ...
                                                  const StrategyConfig& config)
{
    ...
    for (std::size_t i = 0; i < bars.size(); ++i) {
        ...
        out.short_ma = simple_moving_average(closes, i, static_cast<std::size_t>(config.short_ma_period));
        out.long_ma = simple_moving_average(closes, i, static_cast<std::size_t>(config.long_ma_period));
