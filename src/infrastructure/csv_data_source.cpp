...
SampleDataSource::SampleDataSource(int bars_per_symbol)
    : bars_per_symbol_(bars_per_symbol)
{
}

std::vector<MarketSeries> SampleDataSource::load(const std::vector<std::string>& symbols)
{
    return generate_sample_market_data(symbols, bars_per_symbol_);
}
